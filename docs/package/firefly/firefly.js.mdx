...
| --- | --- | --- | --- |
| `entries` | `Record<string, string>` | - | The entry files. Key is the name of the entry, value is the relative path to the file. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `path` | `string` | `"build"` | The path where to store the built files. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `packages` | `string` | - | The names of the packages to compile. |
