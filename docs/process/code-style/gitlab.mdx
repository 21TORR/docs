...
![Badge 'needs review'](img/needs-review.png)
...
![Badge 'needs work'](img/needs-work.png)
...
![Badge 'waiting for dependencies'](img/waiting-for-dependencies.png)
...
![Badge 'suspended'](img/suspended.png)
