...
const FeatureList: FeatureItem[] = [
  {
    ...
    image: <img src={placeImage} alt="Photo from coffee house in Jakarta, Indonesia" className={styles.featureImage} />,
    description: (
      <>
  ...
  },
  {
    ...
    image: <img src={helpImage} alt="Photo of a building during construction" className={styles.featureImage} />,
    description: (
      <>
  ...
  {
    title: 'Work with us',
    image: <img src={joinImage} alt="Photo from Stuttgart, Germany" className={styles.featureImage} />,
    description: (
      <>
...
function Feature({title, image, description}: FeatureItem) {
  return (
    <div className={clsx('col col--4')}>
      <div className={`text--center ${styles.featureImageContainer}`}>{image}</div>
